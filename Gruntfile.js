...
module.exports = function (grunt) {
    ...
    grunt.registerTask("vso-create", function () {
        ...
        grunt.util.spawn(
            ...
            function(err, result, code) {
                ...
                grunt.log.ok("dist/Touchify.vsts-typings-" + config.pkg.version + ".vsix successfully created !");
    ...
    grunt.registerTask("assets", function () {
        copy("screenshots");
        copy("node_modules/vsts-task-lib", "typings-task/node_modules/vsts-task-lib");
        
        copy("typings-task/icon.png");
        copy("typings-task/icon.svg");
    ...
    grunt.registerTask("version", function () {
        ...
        var task = grunt.file.readJSON("typings-task/task.json");
        ...
        writeJSON("typings-task/task.json", task);
    });
